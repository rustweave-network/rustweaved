...
// MsgRequestAnticone implements the Message interface and represents a rustweave
...
// NewMsgRequestAnticone returns a new rustweave RequestPastDiff message that conforms to the
