...
var DefaultUserAgent = fmt.Sprintf("/rustweaved:%s/", version.Version())

// MsgVersion implements the Message interface and represents a rustweave version
...
// NewMsgVersion returns a new rustweave version message that conforms to the
