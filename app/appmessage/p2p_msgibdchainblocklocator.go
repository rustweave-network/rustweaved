...
// MsgIBDChainBlockLocator implements the Message interface and represents a rustweave
...
// NewMsgIBDChainBlockLocator returns a new rustweave locator message that conforms to
