...
// MsgInvTransaction implements the Message interface and represents a rustweave
...
// NewMsgInvTransaction returns a new rustweave TxInv message that conforms to
