...
// MsgRequestHeaders implements the Message interface and represents a rustweave
...
// NewMsgRequstHeaders returns a new rustweave RequestHeaders message that conforms to the
