...
// rustweave Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a rustweave
// Addresses message.
...
// NewMsgAddresses returns a new rustweave Addresses message that conforms to the
