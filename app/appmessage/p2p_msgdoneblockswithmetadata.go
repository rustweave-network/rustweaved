...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a rustweave
...
// NewMsgDoneBlocksWithTrustedData returns a new rustweave DoneBlocksWithTrustedData message that conforms to the
// Message interface.
