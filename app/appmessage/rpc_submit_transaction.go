...
// RPCTransaction is a rustweaved transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a rustweaved transaction input representation
...
// RPCScriptPublicKey is a rustweaved ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a rustweaved transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a rustweaved outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a rustweaved utxo entry representation meant to be used
// over RPC
