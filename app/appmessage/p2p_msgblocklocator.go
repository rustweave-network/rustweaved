...
// MsgBlockLocator implements the Message interface and represents a rustweave
...
// NewMsgBlockLocator returns a new rustweave locator message that conforms to
