...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a rustweave
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new rustweave RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
