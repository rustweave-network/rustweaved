...
// MsgRequestAddresses implements the Message interface and represents a rustweave
...
// NewMsgRequestAddresses returns a new rustweave RequestAddresses message that conforms to the
