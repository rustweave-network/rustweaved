...
// MsgRequestNextHeaders implements the Message interface and represents a rustweave
...
// NewMsgRequestNextHeaders returns a new rustweave RequestNextHeaders message that conforms to the
// Message interface.
