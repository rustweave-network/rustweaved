	...
	tests := []struct {
		...
		// Positive P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixRustweave)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixRustweave,
		},
		{
			name:    "mainnet p2pk 2",
			...
			passedPrefix:   util.Bech32PrefixRustweave,
			expectedPrefix: util.Bech32PrefixRustweave,
		},
		{
			name:    "testnet p2pk",
			...
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixRustweaveTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixRustweaveTest)
			},
			passedPrefix:   util.Bech32PrefixRustweaveTest,
			expectedPrefix: util.Bech32PrefixRustweaveTest,
		},
		...
		// ECDSA P2PK tests.
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixRustweave)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixRustweave,
		},
		...
		// Positive P2SH tests.
		{
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixRustweave)
			},
			passedPrefix:   util.Bech32PrefixRustweave,
			expectedPrefix: util.Bech32PrefixRustweave,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixRustweave)
			},
			passedPrefix:   util.Bech32PrefixRustweave,
			expectedPrefix: util.Bech32PrefixRustweave,
		},
		{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixRustweaveTest)
			},
			passedPrefix:   util.Bech32PrefixRustweaveTest,
			expectedPrefix: util.Bech32PrefixRustweaveTest,
		},
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"rustweave", util.Bech32PrefixRustweave, false},
		{"rustweavetest", util.Bech32PrefixRustweaveTest, false},
		{"rustweavesim", util.Bech32PrefixRustweaveSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixRustweave, "rustweave"},
		{util.Bech32PrefixRustweaveTest, "rustweavetest"},
		{util.Bech32PrefixRustweaveSim, "rustweavesim"},
		{util.Bech32PrefixUnknown, ""},
	}
