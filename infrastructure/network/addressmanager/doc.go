/*
Package addressmanager implements concurrency safe Rustweave address manager.

# Address Manager Overview

In order maintain the peer-to-peer Rustweave network, there needs to be a source
of addresses to connect to as nodes come and go. The Rustweave protocol provides
