...
import (
	...
	"github.com/rustweave-network/rustweaved/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.RustweavedMessage) error
	Recv() (*protowire.RustweavedMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.RustweavedMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.RustweavedMessage) error {
