...
type P2P_MessageStreamClient interface {
	Send(*RustweavedMessage) error
	Recv() (*RustweavedMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *RustweavedMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*RustweavedMessage, error) {
	m := new(RustweavedMessage)
...
func (x *p2PMessageStreamServer) Send(m *RustweavedMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*RustweavedMessage, error) {
	m := new(RustweavedMessage)
...
func (x *rPCMessageStreamClient) Send(m *RustweavedMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*RustweavedMessage, error) {
	m := new(RustweavedMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *RustweavedMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*RustweavedMessage, error) {
	m := new(RustweavedMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
