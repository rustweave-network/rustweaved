...
func (x *RustweavedMessage_PruningPoints) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *RustweavedMessage_PruningPoints) fromAppMessage(msgPruningPoints *appmessage.MsgPruningPoints) error {
