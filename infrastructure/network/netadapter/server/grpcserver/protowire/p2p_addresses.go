...
func (x *RustweavedMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "RustweavedMessage_Addresses is nil")
	}
...
func (x *RustweavedMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
