...
type GetBlockTemplateRequestMessage struct {
	...
	// Which rustweave address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether rustweaved thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when rustweaved is not synced.
	// That is because when rustweaved isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this rustweaved initiated the connection
	...
	// The timestamp of when this peer connected to this rustweaved
