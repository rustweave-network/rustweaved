...
func (x *RustweavedMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "RustweavedMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *RustweavedMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
