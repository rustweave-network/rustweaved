...
func (x *RustweavedMessage_GetHeadersRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *RustweavedMessage_GetHeadersRequest) fromAppMessage(message *appmessage.GetHeadersRequestMessage) error {
...
func (x *RustweavedMessage_GetHeadersResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *RustweavedMessage_GetHeadersResponse) fromAppMessage(message *appmessage.GetHeadersResponseMessage) error {
	var err *RPCError
