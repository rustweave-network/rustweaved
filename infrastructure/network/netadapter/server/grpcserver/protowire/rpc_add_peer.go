...
func (x *RustweavedMessage_AddPeerRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *RustweavedMessage_AddPeerRequest) fromAppMessage(message *appmessage.AddPeerRequestMessage) error {
...
func (x *RustweavedMessage_AddPeerResponse) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *RustweavedMessage_AddPeerResponse) fromAppMessage(message *appmessage.AddPeerResponseMessage) error {
	var err *RPCError
