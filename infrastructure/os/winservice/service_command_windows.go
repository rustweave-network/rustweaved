...
// installService attempts to install the rustweaved service. Typically this should
...
// removeService attempts to uninstall the rustweaved service. Typically this should
...
// startService attempts to Start the rustweaved service.
