...
var genesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x14, 0xf0, 0xdc, 0xeb, 0x4b, 0x42, 0xb4, 0x2, 0x9, 0x67, 0x5e, 0xc7, 0x7e, 0x9f, 0x96, 0xe0, 0x13, 0x12, 0xa6, 0x16, 0x78, 0xb3, 0x11, 0x99, 0x99, 0x7a, 0xd9, 0x1b, 0x2b, 0xb9, 0x1c, 0xc9,
})

// genesisMerkleRoot is the hash of the first transaction in the genesis block
// for the main network.
var genesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0xe3, 0xe5, 0x1f, 0x46, 0xdd, 0xc3, 0xf5, 0xa3, 0x6f, 0xed, 0xa, 0xc3, 0xd4, 0x95, 0x47, 0xc9, 0x1e, 0x57, 0x28, 0xd4, 0xb0, 0x83, 0x3d, 0xe3, 0x33, 0xb1, 0x12, 0xc8, 0x33, 0x6d, 0x47, 0xc0,
})
...
var devnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // rustweave-devnet
}
...
var simnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // rustweave-simnet
}
...
var testnetGenesisTxPayload = []byte{
	...
	0x01,                                                                         // Varint
	0x00,                                                                         // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, // rustweave-testnet
}
