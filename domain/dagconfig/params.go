...
// Params defines a Rustweave network by its parameters. These parameters may be
// used by Rustweave applications to differentiate networks as well as addresses
...
// MainnetParams defines the network parameters for the main Rustweave network.
var MainnetParams = Params{
	...
	DevFeeScript: &externalapi.ScriptPublicKey{
		Version: 0,
		Script:  []byte{0x20, 0xd6, 0xa8, 0x2, 0x68, 0x97, 0x4e, 0xb1, 0x60, 0xb4, 0x25, 0x45, 0xc8, 0x9d, 0xde, 0xd5, 0x39, 0x56, 0x45, 0x3e, 0xee, 0x6a, 0xa0, 0x98, 0xd9, 0x88, 0x68, 0x67, 0xeb, 0x4e, 0xc0, 0x82, 0xca, 0xac},
	},
	...
	Prefix: util.Bech32PrefixRustweave,
...
// TestnetParams defines the network parameters for the test Rustweave network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "rustweave-testnet-10",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixRustweaveTest,
...
// SimnetParams defines the network parameters for the simulation test Rustweave
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixRustweaveSim,
...
// DevnetParams defines the network parameters for the development Rustweave network.
var DevnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "rustweave-devnet",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixRustweaveDev,
...
// ErrDuplicateNet describes an error where the parameters for a Rustweave
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Rustweave network")

var registeredNets = make(map[appmessage.RustweaveNet]struct{})

// Register registers the network parameters for a Rustweave network. This may
