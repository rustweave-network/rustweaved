...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerRustweave
	defaultPreDeflationaryPhaseBaseSubsidy         = 500 * constants.SompiPerRustweave
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SompiPerRustweave
