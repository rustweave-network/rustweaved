...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One rustweave is a quantity of sompi as defined by the
	// sompiPerRustweave constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Rustweave, but perhaps possible if an alt increases
