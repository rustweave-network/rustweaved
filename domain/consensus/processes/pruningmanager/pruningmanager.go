...
import (
	...
	"github.com/rustweave-network/rustweaved/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that rustweaved doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
