/*
Package txscript implements the rustweave transaction script language.

This package provides data structures and functions to parse and execute
rustweave transaction scripts.

# Script Overview

Rustweave transaction scripts are written in a stack-base, FORTH-like language.

The rustweave script language consists of a number of opcodes which fall into
...
Typical rustweave scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend rustweave.
