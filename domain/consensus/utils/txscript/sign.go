...
// SignatureScript creates an input signature script for tx to spend RWE sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend RWE sent
