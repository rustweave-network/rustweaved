...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := rustweaved.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = rustweaved.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = rustweaved.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
