...
func parseCommand(args []string, commandDescs []*commandDescription) (*protowire.RustweavedMessage, error) {
	...
	return generateRustweavedMessage(commandValue, commandDesc)
}
