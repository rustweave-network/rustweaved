...
var keyChains = []uint8{librustweavewallet.ExternalKeychain, librustweavewallet.InternalKeychain}
...
func (s *server) updateAddressesAndLastUsedIndexes(requestedAddressSet walletAddressSet,
	...
	for _, entry := range getBalancesByAddressesResponse.Entries {
		...
		if walletAddress.keyChain == librustweavewallet.ExternalKeychain {
