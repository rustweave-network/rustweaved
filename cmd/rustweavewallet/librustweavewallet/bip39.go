...
import (
	...
	"github.com/rustweave-network/rustweaved/cmd/rustweavewallet/librustweavewallet/bip32"
...
func versionFromParams(params *dagconfig.Params) ([4]byte, error) {
	...
	case dagconfig.MainnetParams.Name:
		return bip32.RustweaveMainnetPrivate, nil
	case dagconfig.TestnetParams.Name:
		return bip32.RustweaveTestnetPrivate, nil
	case dagconfig.DevnetParams.Name:
		return bip32.RustweaveDevnetPrivate, nil
	case dagconfig.SimnetParams.Name:
		return bip32.RustweaveSimnetPrivate, nil
	}
