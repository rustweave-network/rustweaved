...
// RustweavewalletdUTXOsTolibrustweavewalletUTXOs converts a  []*pb.UtxosByAddressesEntry to a []*librustweavewallet.UTXO
func RustweavewalletdUTXOsTolibrustweavewalletUTXOs(rustweavewalletdUtxoEntires []*pb.UtxosByAddressesEntry) ([]*UTXO, error) {
	UTXOs := make([]*UTXO, len(rustweavewalletdUtxoEntires))
	for i, entry := range rustweavewalletdUtxoEntires {
